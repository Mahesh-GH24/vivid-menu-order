def place_order(menu):
    ...
    while True:    
        ...
        continue_ordering = input("Would you like to keep ordering? Type 'n' or 'N' to quit:") 
        ...
        if continue_ordering.lower() == 'n':
            ...
            prices_list = [ float(price_quantity["Price"]) * int(price_quantity["Quantity"])  for price_quantity in order ]
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if converted_menu_selection in menu_items.keys():

            # TODO: Store the item name as a variable
            #item_name = menu_items[converted_menu_selection]
            item_name = menu_items[converted_menu_selection].get("Item name")
            ...
            order_placed["Price"] = menu_items[converted_menu_selection].get("Price")
            order_placed["Quantity"] = int(quantity)
